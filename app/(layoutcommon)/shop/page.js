...
const featuredProducts = [
  ...
  },
  {
    ...
    description:
      "From water bottles to wristbands, we've got a range of sporting accessories that will keep you in top form while you show your UC Cup spirit.",
  },
  {
      ...
      <div className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Don't forget to join our mailing list and follow us on social media
            to stay updated on new arrivals, promotions, and exclusive offers.
            Your support through the UC Cup Shop not only allows you to showcase
