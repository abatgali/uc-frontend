  ...
  return (
    ...
    <div className="w-full h-[20rem] object-cover bg-gradient-to-b from-black to-gray-900 relative max-sm:hidden">
      ...
      <div className="flex flex-wrap justify-evenly h-auto mx-auto sm:py-10 w-fit ">
        {events.map((event) => (
          <div className="md:w-[40em] bg-gradient-to-t object-cover from-gray-800 to-black w-full hover:shadow-xl relative transform transition-all duration-500 ease-in-out md:hover:scale-105 overflow-hidden h-auto">
            <img
