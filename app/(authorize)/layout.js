      ...
      <body className="flex min-h-full flex-1 bg-white">
        <div className="relative hidden w-0 flex-1 lg:block ">
          ...
          <div className="absolute inset-0 p-16">
            <Link href="/">
            <div className="flex items-baseline"><LogoIcon/>
            <p className="text-white font-extrabold text-3xl ml-4 mb-24"> United Chin International</p></div>
            </Link>
            <h2 className="mt-20 text-5xl font-extrabold text-white">Experience Community, Join Today!</h2>
            <p className="text-white mt-20 text-2xl w-2/3">Sign up to access events, play sports and stay up to date on UC Cup 24™ qualification!</p>
