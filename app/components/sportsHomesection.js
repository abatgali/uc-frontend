...
export default function MobileHero() {
  return (
    <div className="w-full px-3 h-auto py-10">
      ...
      <div className="flex flex-wrap justify-around">
        <div className="w-auto">
          <div className="bg-yellow-900 w-36 h-36 ">
            <img
              src="https://res.cloudinary.com/dtyw96fds/image/upload/v1695499027/thumbnail_soccer_f95972066c.jpg"
        ...
        <div className="w-auto">
          <div className="bg-yellow-900 w-36 h-36">
            <img
              src="https://res.cloudinary.com/dtyw96fds/image/upload/v1695156454/thumbnail_idol_3aea1d1f22.jpg"
              className="w-full h-full object-cover opacity-70"
            />
          </div>
        ...
        <div className="w-auto">
          <div className="bg-yellow-900 w-36 h-36">
            <img
              src="https://res.cloudinary.com/dtyw96fds/image/upload/v1695156454/thumbnail_beautypageant_f6e79a60c0.jpg"
              className="w-full h-full object-cover object-top opacity-70"
            />
          </div>
          <p className="text-center py-3 font-semibold">Miss & Mister</p>
        </div>
        <div className="w-auto">
          <div className="bg-yellow-900 w-36 h-36 ">
            <img
