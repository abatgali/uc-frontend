const people = [
  ...
  },
  {
    ...
    role: 'Event Manager',
    imageUrl:
      'https://res.cloudinary.com/dtyw96fds/image/upload/v1695491508/photographer_lj7k3d.jpg',
    twitterUrl: '#',
    linkedinUrl: '#',
  },
  {
    ...
    imageUrl:
      'https://res.cloudinary.com/dtyw96fds/image/upload/v1695491847/third_lbf7x0.jpg',
    twitterUrl: '#',
    linkedinUrl: '#',
  },
]
      ...
      <div className='mx-auto max-w-7xl px-6 text-center lg:px-8'>
        ...
        >
          {people.map((person) => (
            <li key={person.name}>
              <img
                className='mx-auto h-56 w-56 rounded-full bg-center object-cover'
                src={person.imageUrl}
                alt=''
              />
