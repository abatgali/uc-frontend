export default function Hero() {
    ...
    <div className="w-full">
      <video className="z-0 " src="https://res.cloudinary.com/dtyw96fds/video/upload/v1695156461/soccer_net_89176b6663.mp4" autoPlay loop muted controlsList="play nofullscreen nodownload noremoteplayback noplaybackrate foobar ">
      </video> 
        <div className="mx-auto max-w-2xl -mt-[180px] sm:-py-56 lg:-mt-[300px]">
          ...
          <div className="text-center">
            ...
            <div className="mt-10  flex items-center justify-center gap-x-6">
              ...
              <a href="#faqs" className="text-sm font-semibold leading-6 z-10 text-white">
