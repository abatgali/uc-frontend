...
export default function Profile({ name, email }) {
  return (
    <div className='h-screen bg-gradient-to-b from-slate-600 to-slate-400 pt-24 md:px-24'>
      ...
      <div className="object-cover mx-auto w-max">
        {
          <div
            className={`${oswald.className} h-24 w-24 rounded-full bg-gray-950 flex items-center justify-center text-gray-300 text-2xl font-bold`}
          >
            {name.charAt(0)}
          </div>
        }
      ...
      <div className="mt-6 border-t border-gray-100">
        <dl className="divide-y divide-gray-100">
          ...
          <form action="/auth/signout" method="post" className="">
            <button className="button block bg-black m-10 p-2 text-white w-24 mx-auto" type="submit">
              Sign out
            </button>
          </form>
          {/* <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
